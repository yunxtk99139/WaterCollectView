...
SWIFT_CLASS("_TtC8TestDemo9ImageCell")
@interface ImageCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIView * __null_unspecified bgView;
@property (nonatomic, weak) IBOutlet UIImageView * __null_unspecified imageView;
- (void)awakeFromNib;
- (void)showImage:(NSString * __nonnull)imagename;
...
SWIFT_CLASS("_TtC8TestDemo10ImageModel")
...
SWIFT_CLASS("_TtC8TestDemo12ImageScanCtl")
@interface ImageScanCtl : UIViewController <UIScrollViewDelegate, UICollectionViewDelegate, UICollectionViewDataSource>
@property (nonatomic, copy) NSArray<NSString *> * __nonnull images;
@property (nonatomic, copy) NSArray<NSNumber *> * __nonnull heights;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8TestDemo11WaterLayout")
@interface WaterLayout : UICollectionViewLayout
@property (nonatomic) NSInteger lineNumber;
@property (nonatomic) CGFloat rowSpacing;
@property (nonatomic) CGFloat lineSpacing;
@property (nonatomic) UIEdgeInsets sectionInset;
@property (nonatomic, copy) NSDictionary<NSNumber *, NSNumber *> * __nonnull dicOfHeight;
@property (nonatomic, copy) NSArray<UICollectionViewLayoutAttributes *> * __nonnull array;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, copy) CGFloat (^ __nullable block)(NSIndexPath * __nonnull, CGFloat);
- (nullable instancetype)initWithCoder:(NSCoder * __nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)prepareLayout;
...
- (void)computeIndexCellHeightWithWidthBlock:(CGFloat (^ __nonnull)(NSIndexPath * __nonnull, CGFloat))block;
@end
